          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <p className="text-sm font-medium text-muted-foreground">MOE Registration</p>
                  <p className="font-semibold">{payment.moeRegistration}</p>
                </div>
              </CardContent>
            </Card>
          </div>
...
export default function PaymentsPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch(`/api/payments/stats${academicYearParam}`);
